...
function Countdown(){
  ...
  useEffect(()=>{ const tick=()=>{const ms=new Date('2026-08-05T09:05:00+02:00')-new Date();const hours=Math.max(0,Math.floor(ms/3600000)),days=Math.floor(hours/24),remainingHours=hours%24;setText(`${days} Tage · ${remainingHours} Std. bis Abflug`)};tick();const id=setInterval(tick,60000);return()=>clearInterval(id)},[])
  return text
}
