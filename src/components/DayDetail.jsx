...
export default function DayDetail({day,index,total,onChange,favorites,setFavorites}){
 ...
 const google=`https://www.google.com/maps/dir/?api=1&destination=${day.coordinates.at(-1).lat},${day.coordinates.at(-1).lng}&waypoints=${day.coordinates.slice(0,-1).map(p=>`${p.lat},${p.lng}`).join('|')}`
